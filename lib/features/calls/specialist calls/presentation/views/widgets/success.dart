      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Center(child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyles.stylePoppinsMedium16SuccessBody.copyWith(fontSize: 20.sp),
            ...
            CustomButton(
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context) => const Specialist()));

              },
              buttonBody: Text(
                'Back To Home',
                style: TextStyles.stylePoppinsRegular14Hint.copyWith(color: Colors.white, fontSize: 16.sp)
        
                ), width: double.infinity, color: AppColors.primaryColor,)
          ],
        ),
      ),
    );
