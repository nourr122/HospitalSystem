          ...
          Column(
            ...
            Row(
              children: [
                  ...
                  SizedBox(width:screenwidth/30),
                  Text(style: TextStyle(fontFamily:'poppins',fontSize: screenwidth*0.032,),"Ebrahim Khaled")],
            ),
            SizedBox(height: screenheight/50),
            Row(
              children:[
                SizedBox(width:screenwidth/30),
                  ...
                  SizedBox(width:screenwidth/30),
                  Text(style: TextStyle(fontFamily:'poppins',fontSize: screenwidth*0.032),"24 . 4 . 2021")
              ]),
              SizedBox(height:screenheight/50),
              OutlinedButton(
                onPressed: (){
